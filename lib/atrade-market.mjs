...
export function validateMarket(d,now=Date.now()){
 if(d.version!==1||d.account!=='23091074'||d.server!=='Ava-Demo')throw Error('Unexpected market account');
